...
class UserDeshboardComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.user.user-deshboard-component',['orders' => $orders,'totalCost' => $totalCost,'totalPurchase' => $totalPurchase,'totalDelivered' => $totalDelivered,'totalCanceled' => $totalCanceled])->layout('layouts.base');
    }
}
