...
class AdminDeshboardComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.admin.admin-deshboard-component',['orders' => $orders,'totalSales' => $totalSales,'totalRevenue' => $totalRevenue,'todaySales' => $todaySales,'todayRevenue' => $todayRevenue])->layout('layouts.base');
    }
}
