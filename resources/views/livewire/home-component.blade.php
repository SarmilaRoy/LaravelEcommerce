                     ...
                     <div class="product product-style-2 equal-elem ">
                         <div class="product-thumnail">
                             <a href="{{ route('product.details', ['slug' => $sale_product->slug]) }}" title="{{ $sale_product->name }}">
                                 <figure><img src="{{ asset('assets/images/products') }}/{{ $sale_product->image }}"
                                         width="800" height="800" alt="{{ $sale_product->name }}"></figure>
                             </a>
                         ...
                         <div class="product-info">
                             ...
                             <div class="wrap-price"><ins>
                                     <p class="product-price">${{ $sale_product->sale_price }}</p>
                                 </ins> <del>
