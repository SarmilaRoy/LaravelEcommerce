    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            <div class="wrap-iten-in-cart">
                ...
                @else
                    <h3>
                        <p style="color: red;">No cart in Item</p>
                    </h3>
                ...
                <div class="order-summary">
                    ...
                    @if(Session::has('coupon'))
                        <p class="summary-info"><span class="title">Discount
                                ({{ Session::get('coupon')['code'] }})<a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times taxt-danger"></i></a></span><b class="index">
                                -${{ number_format($discount, 2) }}</b>
                        </p>
                        <p class="summary-info"><span class="title">Subtotal with Discount
                            </span><b class="index">${{ number_format($subTotalAfterDiscount, 2) }}</b>
                        </p>
                        <p class="summary-info"><span class="title">Tax ({{config('cart.tax')}}%)
                            </span><b class="index">${{ number_format($texAfterDiscount, 2) }}</b>
                        </p>

                        <p class="summary-info total-info "><span class="title">Total</span><b
                                class="index">${{ number_format($totalAfterDiscount, 2) }}</b>
                        </p>
                    @else
                        ...
                        @if ($haveCouponCode == 1)
                            <div class="summary-item">
                                <form wire:submit.prevent="applyCouponCode">
                                    ...
                                    @if (Session::has('msg_coupon'))
                                        <div class="alert alert-danger" role="danger">
                                            {{ Session::get('msg_coupon') }}</div>
                                    @endif
                                    <p class="row-in-form">
        ...
        <div class="wrap-iten-in-cart">
            ...
            @if (Session::has('moveTocart-msg'))
                <div class="alert alert-success">
                    <strong> Success </strong> {{ Session::get('moveTocart-msg') }}
                </div>
            @endif
            ...
            @else
                <h3>
                    <p style="color: red;">No cart saved for later</p>
                </h3>
